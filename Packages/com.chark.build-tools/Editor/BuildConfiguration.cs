...
namespace CHARK.BuildTools.Editor
{
    ...
    internal sealed class BuildConfiguration : ScriptableObject, ICloneable
    {
...
#endif
        [SerializeField]
        private string archiveDelimiter = " ";
...
#endif
        [SerializeField]
        private bool isLowerCaseArchiveName;

#if ODIN_INSPECTOR
        [Sirenix.OdinInspector.FoldoutGroup("Archive", Expanded = true)]
#endif
        [SerializeField]
        private bool isDashArchiveName;
        ...
        public string ArchiveDelimiter => archiveDelimiter;
        ...
        public bool IsLowerCaseArchiveName => isLowerCaseArchiveName;

        public bool IsDashArchiveName => isDashArchiveName;
